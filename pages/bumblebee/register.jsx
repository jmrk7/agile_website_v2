...
const Register = () => {
  ...
  const [verified, setVerified] = useState(process.env.DISABLE_RECAPTCHA)
        ...
        <div className="container">
          <div className="navbar-header">
            ...
            <div className="navbar-brand">
              <a onClick={goBumblebee} style={{cursor: "pointer"}}>
          ...
          <div className="collapse navbar-collapse" id="menu-collapse-1">
            <ul className="nav navbar-nav navbar-right" style={{overflow: "visible"}}>
              ...
              <li><Link href="/bumblebee#features" className="smooth-scroll">Features</Link></li>
              <li><a href="/docs/bumblebee-docs/en/latest/" target="_blank" className="smooth-scroll">Docs</a></li>
              <li><Link href="/bumblebee#pricing" className="smooth-scroll">Pricing</Link></li>
              <li><Link href="/bumblebee#download" className="smooth-scroll">Download</Link></li>
    ...
    <div id="contact" className="margin-bottom40">
      <div className="container">
        <div className="post-heading-center" style={{marginTop: "30px"}}>
          <h2>Try Bumblebee Risk Free for 14 Days</h2>
        </div>
                    ...
                    <div className="row">
                      ...
                      <div className="col-md-6 col-lg-6 px-3">
                        <div className="form-group">
                          ...
                          <input type="text" className="form-control required" name="r_lname" placeholder="Enter Last Name" value={userinfo.l_fname} onChange={(event) => changeUserinfo("r_lname", event)} />
                        </div>
                      </div>
                    </div>
                    <div className="row">
