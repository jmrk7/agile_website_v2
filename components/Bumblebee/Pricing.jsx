        ...
        <div className="row">
          <div className="col-sm-12 col-lg-6-pri col-md-offset-3 tbl-prc-col tbl-prc-col-org pricing-item2 text-center-sm" data-animation="animation-fade-in-down" data-delay="600">
            <div className="tbl-prc-wrap">
              ...
              <ul className="tbl-prc-list enter-prise" style={{maxWidth:"440px", marginLeft: "auto !important", marginRight:"auto"}}>
                <li><i className="fa fa-check"></i>&nbsp;&nbsp;&nbsp;&nbsp;Defect Management workflows (coming soon)</li>
                ...
                <li><i className="fa fa-check"></i>&nbsp;&nbsp;&nbsp;&nbsp;Customized workflows and features</li>
