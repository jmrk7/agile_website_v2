...
export default function Header() {
  ...
  return (
      ...
      <div className="container">
        <div className="navbar-header">
          ...
          <div className="navbar-brand">
            <a href="#header">
              <img src="/images/firefly/firefly_banner_black.png" alt="Agiletestware" className="hidden-xs" />
              <img src="/images/firefly/firefly_banner.png" alt="Agiletestware" className="visible-xs" />
            </a>
          </div>
        ...
        <div className="collapse navbar-collapse" id="menu-collapse-1">
          <ul className="nav navbar-nav navbar-right" style={{overflow: "visible"}}>
            ...
            <li>
              <a href="#download" className="smooth-scroll">Download</a>
            </li>
            ...
            <li className="trial-cta">
              <a className="free_trial_track" style={{cursor: "pointer"}} title="Firefly Trial" href="https://railflow.io/register/">Free Trial</a>
            </li>
          </ul>
        </div>
      </div>
    ...
    <div className="header-content">
      <div className="container">
        <div className="row header-text-firefly">
          <div className="col-sm-12 col-md-6 col-sm-offset-0 col-md-offset-0 col-lg-5">
            <div className="margin-top40 margin-bottom40">
              <div className="">
                <h1 className="agh1">Meet Firefly, Powerful ReadyAPI plugin for TestRail integration</h1>
              </div>
              <div className="btn-section">
                <a className="btn-custom btn-freetrial free_trial_track" style={{cursor: "pointer"}} title="Firefly Trial" href="https://railflow.io/register/" > Free Trial</a>
