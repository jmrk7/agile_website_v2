...
const SignUpForm = () => {
  ...
  const [isRecaptchaVerified, setIsRecaptchaVerified] = useState(process.env.DISABLE_RECAPTCHA);
    ...
    async (event) => {
      ...
      try {
        ...
        if (
          ...
          Router.push(`/dragonfly/thank-you`);
        } else {
  ...
  return (
    ...
    <form className={cx("signUpForm")} onSubmit={handleSubmit}>
      <h2 className={cx("signUpForm_title")}>
        Try Dragonfly Risk Free for 14 Days
      </h2>
