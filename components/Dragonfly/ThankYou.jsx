      ...
      <LayoutSectionContainer>
        <div className={cx("thankYou_sectionContainer")}>
          <h1 className={cx("thankYou_title")}>
            Thank you for signing up with Dragonfly.
          </h1>
          ...
          <p className={cx("thankYou_text")}>
            ...
            <a
              ...
              href="https://agiletestware.atlassian.net/servicedesk/customer/portal/2"
              target="_blank"
            >
              support portal
            </a>
          ...
          <div className={cx("thankYou_linkitem")}>
            ...
            <a
              rel="noopener noreferrer"
              href="http://dragonfly.agiletestware.com/"
              target="_blank"
            >
              Dragonfly User Documentation
            </a>
          </div>
          <p className={cx("thankYou_text")}>
